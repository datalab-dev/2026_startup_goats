...
Instead of giving one overall opinion, the system breaks a goat down into individual traits (such as udder shape, leg structure, etc.) and scores each on a 1 - 50 scale.
